...
int main()
{
    ...
    carta1.super_poder = (float)carta1.população + carta1.area + carta1.PIB + carta1.densidade_popu +
    ...
    carta2.super_poder = (float)carta2.população + carta2.area + carta2.PIB + carta2.densidade_popu +
